...
// shared memory size
#define H_SHX_V5 (BLX_P + BLT_MM_V5) 
#define H_SHY_V5 (BLY_P + BLT_MM_V5) 
#define H_SHZ_V5 (BLZ_P + BLT_MM_V5) 
#define E_SHX_V5 (BLX_P + BLT_MM_V5)
#define E_SHY_V5 (BLY_P + BLT_MM_V5)
#define E_SHZ_V5 (BLZ_P + BLT_MM_V5)
